...
function CheckoutForm() {
  ...
  if (errorMsg) {
    return (
      <div className="max-w-md mx-auto my-20 p-6 bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-2xl text-center shadow-2xl">
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 py-10 px-4 selection:bg-indigo-500/30 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto space-y-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="bg-white dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-slate-800/80 p-5 rounded-2xl shadow-xl flex flex-col justify-between jelly-card transition-colors duration-300">
            <div className="space-y-5">
              ...
              {/* Account Details Box */}
              <div className="space-y-3 bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-850 p-4 rounded-xl text-xs font-medium transition-colors duration-300">
                ...
                <div className="pt-3 border-t border-slate-200 dark:border-slate-850 space-y-1">
                  ...
                  <div className="flex justify-between items-center bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-150 dark:border-indigo-900/40 p-2 rounded-lg">
                    <span className="font-extrabold text-indigo-600 dark:text-indigo-400 font-mono tracking-widest text-xs">
                      {cvId}
                    </span>
                  </div>
                </div>
          ...
          <div className="bg-white dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-slate-800/80 p-5 rounded-2xl shadow-xl flex flex-col justify-between jelly-card transition-colors duration-300">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {slipBase64 && (
                <div className="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-150 dark:border-emerald-900/40 p-2 rounded-xl flex items-center justify-between text-[9px] text-emerald-600 dark:text-emerald-400 font-bold">
            ...
            <div className="border-t border-slate-200 dark:border-slate-800 pt-3 mt-4 flex flex-col items-center">
              ...
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-black text-xs rounded-xl shadow-lg shadow-emerald-600/15 hover:shadow-emerald-600/35 transition-all jelly-btn relative overflow-hidden group"
              >
          ...
          <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 p-5 rounded-2xl shadow-xl flex flex-col items-center relative overflow-hidden jelly-card transition-colors duration-300">
            ...
            <div className="absolute inset-0 bg-slate-950/20 backdrop-blur-[6px] z-30 flex flex-col items-center justify-center p-6 text-center select-none">
              <div className="w-12 h-12 rounded-full bg-amber-500/10 border border-amber-500/30 flex items-center justify-center mb-4 text-amber-500 animate-pulse">
                🔒
              </div>
              ...
              <p className="text-[9px] text-slate-350 mt-2 max-w-[180px] leading-relaxed drop-shadow">
                {lang === 'si' 
